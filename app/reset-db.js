...
let records = '{"type":"win-state","maxed":false,"position":[null,null],"size":[1280,800],"_id":"0"}\n' +
    ...
    '{"type":"search","rs_count":100,"smart":true,"inst":false,"_id":"2"}\n' +
    ...
    '{"type":"gen","sysTray":true,"logToFile":true,"useDHT":true,"supMsg":"' + new Date().toISOString() +'","_id":"4"}\n' +
    '{"type":"etc","thmURL":"https://www.google.com/search?q=OfflineBay%20themes","_id":"5"}\n';
